    ...
    return (
      <div className={`relative mt-1 ${effectiveTranslationOn ? "mb-1" : ""} max-w-[240px]  w-full `}>
        <input
          ...
          aria-label="学习输入"
          autoComplete="off"
          className="w-full rounded-3xl border border-black/10 bg-white/40 px-8 py-2 text-center text-sm text-foreground outline-none transition-colors  focus:border-accent/40 focus:bg-white/50 dark:border-white/10 dark:bg-white/5 dark:focus:bg-white/10"
